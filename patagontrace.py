...
"""
Patagontrace: An AI-powered PCAP analysis utility that you can access directly from your console. 
It facilitates in-depth and comprehensive analysis and troubleshooting of PCAP files through ChatGPT integration. 
By default, the tool provides prompts tailored to 3G, 4G, and 5G protocols.
...
def main():
    ...
    def parse_args():
        parser = argparse.ArgumentParser(description="Patagontrace: Analyze with ChatGPT")
        parser.add_argument(
            "--model",
